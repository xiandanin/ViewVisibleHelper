...
import com.dyhdyh.helper.viewvisible.OnAutoPlayScrollListener;
import com.dyhdyh.helper.viewvisible.RecyclerViewVisibleHelper;
import com.dyhdyh.helper.viewvisible.ViewVisibleInfo;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ExampleAdapter adapter = new ExampleAdapter(ExampleData.randomData(30, file.getAbsolutePath()));
